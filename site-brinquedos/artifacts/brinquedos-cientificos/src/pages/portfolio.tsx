        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          {loading ? (
            <div className="text-center py-20">
              <p className="text-gray-400 text-lg">Carregando brinquedos...</p>
            </div>
              ...
              {filteredToys.map((toy, i) => (
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    ...
                    <p className="text-muted-foreground mb-6 text-lg leading-relaxed text-justify line-clamp-3">{toy.description}</p>
